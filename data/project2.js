  ...
  [
    {
		...
		"name"			: "Test System 5",
		"acronym"		: "TST5",
		"description" 	: "Description for test stystem 5",
		"vendor"		: "Big Corp",
		"version"		: "1.0",
		"docLink"	    : "http://localhost/doclink/tst5",
		"codeLink"		: "http://localhost/codeLink/tst5",
		"color"			: "#ED7D31",
		"techOwner"		: 
		[
			{
				"name" 	: "Earl Haggard",
				"email"	: "EarlH@BigCorp.com"
			}
		],
		"technologies"  : [".NET","C#"],
		"services"    	:	
		[{
			"id"			: "TST5.DOMAIN.001",
			"description"	: "Description for TST5.DOMAIN.001 service",
			"endpointType"	: "REST",
			"endpointVerb"	: "GET",
			"endpointSig"	: "{baseUri}/domain/{domainId}",
			"tags"			: ["domain"],
			"docLink"		: "http://localhost/docLink/TST5.DOMAIN.001"
		},{
			"id"			: "TST3.DOMAIN.005",
			"description"	: "Description for TST5.DOMAIN.002 service",
			"endpointType"	: "REST",
			"endpointVerb"	: "GET",
			"endpointSig"	: "{baseUri}/domain2/{domainId}",
			"tags"			: ["domain"],
			"docLink"		: "http://localhost/docLink/TST5.DOMAIN.002"
		}]
	}
  ]
}